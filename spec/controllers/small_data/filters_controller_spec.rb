...
describe Agilibox::SmallData::FiltersController, type: :controller do
  ...
  describe "form_url" do
    it "should reset page" do
      post :create, params: {filters: {}, form_url: "/agilibox/flyboy/tasks"}
      expect(response).to redirect_to "/agilibox/flyboy/tasks"

      post :create, params: {filters: {}, form_url: "/agilibox/flyboy/tasks?&sort=term&page=3"}
      expect(response).to redirect_to "/agilibox/flyboy/tasks?&sort=term"

      post :create, params: {filters: {}, form_url: "/agilibox/flyboy/tasks?&sort=term&page=3&a=b"}
      expect(response).to redirect_to "/agilibox/flyboy/tasks?&sort=term&a=b"

      post :create, params: {filters: {}, form_url: "/agilibox/flyboy/tasks?page=3&a=b"}
