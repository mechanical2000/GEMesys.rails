...
describe Agilibox::GetHTTP do
  describe "catch and reraise exceptions" do
    def self.it_should_catch_and_reraise(exception)
      it "should catch and reraise #{exception}" do
        ...
        }.to raise_error(Agilibox::GetHTTP::Error)
      end
    end
  ...
  it "should not allow other URIs" do
    instance = described_class.new("ftp://example.org/")

    expect {
      instance.uri
    }.to raise_error(Agilibox::GetHTTP::Error, "invalid URI type : URI::FTP")
  end
